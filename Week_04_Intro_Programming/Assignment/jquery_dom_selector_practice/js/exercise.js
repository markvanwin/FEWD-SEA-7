 ...
 */
 	...
 	function question8(){
 		$(".city").attr("src", "http://lorempixel.com/g/500/400/food"); //When button 3 was clicked, the picture changed from a building to food.
 	}
 ...
 */
	...
	function question9(){
		$("h2").css({color: "blue", font: "Georgia"});
	}
